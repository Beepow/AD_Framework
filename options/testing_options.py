...
class TestOptions():
    ...
    def initialize(self):
        ...
        parser.add_argument('--Dataset', help='Dataset', type=str, default='64_patch')
        ...
        parser.add_argument('--FrameNum', help='frame num for VIDEO clip', type=int, default=64)
        ...
        parser.add_argument('--ModelFilePath', help='Path for a pretrained model.', type=str, default=None)
