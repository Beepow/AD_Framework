...
class TrainOptions():
    ...
    def initialize(self):
        ...
        parser.add_argument('--Dataset', help='Dataset', type=str, default='s_8_res_8_len_1')
        parser.add_argument('--ReSize', help='0 for no resize', type=int, default=0)
        ...
        parser.add_argument('--BatchSize', help='training batchsize', type=int, default=10)
        ...
        ##
        parser.add_argument('--DataRoot', help='DatasetPath', type=str, default='./dataset/')
        parser.add_argument('--FeatureRoot', help='Feature saving Path', type=str, default='./Feature/')
